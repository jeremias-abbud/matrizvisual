...
export const INDUSTRIES = [
  'Advocacia & Jurídico',
  'Agropecuária & Rural',
  'Alimentação & Bebidas (Restaurantes, Delivery)',
  'Arquitetura & Design de Interiores',
  'Artesanato & Feito à Mão',
  'Automotivo (Mecânica, Estética, Lojas)',
  ...
  'Saúde & Bem-estar (Clínicas, Médicos)',
  'Seguros & Previdência',
  'Serviços Domésticos (Limpeza, Marido de Aluguel)',
  'Tecnologia, Software & Startups',
  'Turismo, Viagens & Hotelaria',
  'Varejo & Comércio Local (Lojas Físicas)'
];
...
export const PROJECTS: Project[] = [
  // --- Projetos Iniciais (1-6) ---
  {
    ...
    industry: 'Tecnologia, Software & Startups',
  ...
  },
  {
    ...
    industry: 'Moda, Vestuário & Acessórios',
  ...
  },
  {
    ...
    industry: 'Alimentação & Bebidas (Restaurantes, Delivery)',
  ...
  },
  {
    ...
    category: ProjectCategory.WEB,
    industry: 'Varejo & Comércio Local (Lojas Físicas)',
  ...
  },
  {
    ...
    category: ProjectCategory.LOGO,
    industry: 'Beleza & Estética (Salões, Barbearias, Spas)',
  ...
  },
  {
    ...
    category: ProjectCategory.WEB,
    industry: 'Saúde & Bem-estar (Clínicas, Médicos)',
  ...
  },
  {
    ...
    category: ProjectCategory.VIDEO,
    industry: 'Imobiliária & Corretores',
